      ...
      <TooltipProvider delay={100}>
              ...
              return (
                <Tooltip key={item.href}>
                  ...
                  <TooltipContent
                    side="right"
                    sideOffset={10}
                    className="bg-gray-900 dark:bg-gray-800 text-white font-semibold text-xs px-3 py-1.5 rounded-xl shadow-xl border border-gray-700/50"
                  >
                    {item.name}
                  </TooltipContent>
                </Tooltip>
        ...
        <div className="p-3 border-t border-[#E2E8F0] dark:border-[#243244] space-y-1.5 bg-gray-50/50 dark:bg-gray-900/40">
          ...
          {collapsed ? (
            ...
            >
              <HelpCircle className="w-4 h-4 shrink-0 text-blue-500" />
              <span className="truncate">Platform Tour</span>
            </button>
          )}
        </div>
      </TooltipProvider>
